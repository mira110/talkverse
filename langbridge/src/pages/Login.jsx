...
import { Mail, Lock, ArrowRight, ArrowLeft, Globe, AlertCircle } from "lucide-react";
...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      const syncData = await syncWithBackend(fbUser, idToken);
  ...
  // Direct email/password authentication against MongoDB
    ...
    <div className="min-h-screen bg-light text-text-main flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-text-muted mt-1 text-sm">Sign in to continue your Indic learning journey</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center mb-5">
          ...
          <div className="w-full flex items-center gap-3 my-4">
            ...
            <span className="text-xs text-text-muted font-medium uppercase tracking-wider">or sign in with email</span>
            <div className="h-[1px] bg-light-border flex-1" />
          </div>
        </div>
